import fs from 'fs';
let code = fs.readFileSync('src/data/mattresses.ts', 'utf8');

const competitorMattressesCode = `
...
if (!code.includes('competitorMattresses')) {
  code = code.replace(/];\s*$/, '];\n');
  fs.writeFileSync('src/data/mattresses.ts', code + competitorMattressesCode);
  console.log('Appended competitor mattresses to src/data/mattresses.ts');
} else {
  console.log('competitorMattresses already in src/data/mattresses.ts');
}
